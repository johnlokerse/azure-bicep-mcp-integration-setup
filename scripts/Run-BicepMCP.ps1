...
# Find the built DLL
$McpServerDll = Get-ChildItem -Path (Join-Path $BicepDir "src/Bicep.McpServer/bin/Release") -Filter "Bicep.McpServer.dll" -Recurse -ErrorAction SilentlyContinue | Select-Object -First 1
